export const seo = {
  title: "Logic App Generation",
  description:
    "A Web Application to generate Logic Applications for parsing emails",
  canonical: "https://logic.bsgtech.com/",
};
